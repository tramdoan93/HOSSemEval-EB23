...
def evaluate(data_loader, model, paradigm, task, sents):
    ...
    raw_scores, all_labels, all_preds = compute_scores(
...
print(
    "\n",
    "=" * 30,
    f"NEW EXP: {args.task.upper()} on {args.dataset}",
    "=" * 30,
    "\n",
)
...
if args.do_direct_eval:
    ...
    raw_scores = evaluate(test_loader, model, args.paradigm, args.task, sents)
    # print(scores)
